...
module.exports = function() {
    if (bttv.settings.get('splitChat') !== false) {
        ...
        bttv.settings.get('darkenedMode') === true ? splitCSS.setAttribute('href', 'https://cdn.betterttv.net/css/betterttv-split-chat-dark.css') : splitCSS.setAttribute('href', 'https://cdn.betterttv.net/css/betterttv-split-chat.css');
