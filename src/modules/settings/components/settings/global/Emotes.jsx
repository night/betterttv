          ...
          <Checkbox key="emoteModifiers" value={EmoteTypeFlags.EMOTE_MODIFIERS}>
            ...
            <p className={styles.settingDescription}>
              {formatMessage(
                {
                  defaultMessage:
                    'Emote modifiers allow you to transform emotes in realtime. Wide: <code>w! emoteName</code>, Horizontal Flip: <code>h! emoteName</code>, Vertical Flip: <code>v! emoteName</code>, Zero-Width: <code>z! emoteName</code>, Rotate to Left: <code>l! emoteName</code>, Rotate to Right: <code>r! emoteName</code>',
                },
                {
