  ...
  return (
    <Panel header="Sidebar">
      <div className={styles.setting}>
        <p className={styles.settingDescription}>Edit or modify the left sidebar</p>
        <CheckboxGroup
          ...
          <Checkbox key="featuredChannels" value={SidebarFlags.FEATURED_CHANNELS}>
            ...
            <p className={styles.settingDescription}>Show recommended channels in the sidebar</p>
          </Checkbox>
          <Checkbox key="hideOfflineFollowedChannels" value={SidebarFlags.OFFLINE_FOLLOWED_CHANNELS}>
            ...
            <p className={styles.settingDescription}>Show offline followed channels in the sidebar</p>
          </Checkbox>
