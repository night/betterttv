      ...
      <div className={styles.setting}>
        ...
        <CheckboxGroup
          ...
          <Checkbox key="friends" value={SidebarFlags.FRIENDS}>
            <p>Friends List</p>
            <p className={styles.description}>Show the friends list in the left sidebar</p>
          </Checkbox>
          <Checkbox key="featuredChannels" value={SidebarFlags.FEATURED_CHANNELS}>
            <p>Featured Channels</p>
            <p className={styles.description}>Enable the recommended channels in the sidebar</p>
          </Checkbox>
          <Checkbox key="recommendedFriends" value={SidebarFlags.RECOMMENDED_FRIENDS}>
            <p>Recommended Friends</p>
            <p className={styles.description}>Enable the recommended friends section in the sidebar</p>
          </Checkbox>
          <Checkbox key="hideOfflineFollowedChannels" value={SidebarFlags.OFFLINE_FOLLOWED_CHANNELS}>
            <p>Offline Followed Channels</p>
            <p className={styles.description}>Enable offline followed channels in the sidebar</p>
          </Checkbox>
