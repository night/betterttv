      ...
      <div className={styles.setting}>
        ...
        <CheckboxGroup
          ...
          <Checkbox key="localized" value={UsernameFlags.LOCALIZED}>
            ...
            <p className={styles.description}>Hides localized display names in chat</p>
          </Checkbox>
          <Checkbox key="usernameColors" value={UsernameFlags.COLORS}>
            <p>Username Colors</p>
            <p className={styles.description}>
              Disables username colors in chat (useful for those with color blindness)
            </p>
          </Checkbox>
          <Checkbox key="readableColors" value={UsernameFlags.READABLE}>
            <p>Readable Colors</p>
            <p className={styles.description}>Makes chat usernames higher contrast (prevents hard to read names)</p>
          </Checkbox>
        </CheckboxGroup>
      </div>
    </Panel>
