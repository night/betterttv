...
export const SettingIds = {
  ...
  FIRST_MESSAGE_HIGHLIGHT_COLOR: 'firstMessageHighlightColor',
  ...
  DELETED_MESSAGES_HIGHLIGHT_COLOR: 'deletedMessagesHighlightColor',
...
export const SettingDefaultValues = {
  ...
  [SettingIds.DELETED_MESSAGES_HIGHLIGHT_COLOR]: null,
  ...
  [SettingIds.FIRST_MESSAGE_HIGHLIGHT_COLOR]: null,
